...
![Dashboard Home Overview](data/cc1.png)
...
| :---: | :---: |
| ![Contract & ISP Analysis](data/cc2.png) | ![SHAP Beeswarm Plot](data/cc3.png) |
...
│   ├── cc1.png                     # Dashboard home overview screenshot
│   ├── cc2.png                     # EDA plots screenshot
│   └── cc3.png                     # SHAP beeswarm plot screenshot
